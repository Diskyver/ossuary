...
fn corruption() {
    ...
    let corruptions = [
        ...
        (
            ...
            0,
            0xaa,
            OssuaryError::InvalidPacket("Oversized packet"),
            true,
        ),
        (
            Corruption::ClientInvalidPkt,
            ...
            2,
            0xaa,
            OssuaryError::InvalidPacket("Message ID does not match"),
            true,
        ),
        (
            Corruption::ClientInvalidPkt,
        ...
        (
            ...
            4,
            0xaa,
            OssuaryError::InvalidPacket("Received unexpected handshake packet."),
            true,
        ),
        (
        ...
        (
            ...
            18,
            0xaa,
            OssuaryError::InvalidPacket("Invalid packet length"),
            false,
        ),
        (
