...
#[no_mangle]
pub extern "C" fn ossuary_create_connection(
    conn_type: u8,
    auth_key: *const u8,
...
#[no_mangle]
pub extern "C" fn ossuary_add_authorized_key(
    ...
    let r_key_buf: &[u8] = unsafe { std::slice::from_raw_parts(key_buf, KEY_LEN) };
...
#[no_mangle]
pub extern "C" fn ossuary_add_authorized_keys(
    conn: *mut OssuaryConnection,
    keys: *const *const u8,
    key_count: u8,
) -> i32 {
...
#[no_mangle]
pub extern "C" fn ossuary_set_secret_key(conn: *mut OssuaryConnection, key: *const u8) -> i32 {
...
#[no_mangle]
pub extern "C" fn ossuary_recv_handshake(
    conn: *mut OssuaryConnection,
    in_buf: *const u8,
    in_buf_len: *mut u16,
) -> i32 {
...
#[no_mangle]
pub extern "C" fn ossuary_send_handshake(
    conn: *mut OssuaryConnection,
    out_buf: *mut u8,
    out_buf_len: *mut u16,
) -> i32 {
...
#[no_mangle]
pub extern "C" fn ossuary_send_data(
    conn: *mut OssuaryConnection,
    in_buf: *mut u8,
    in_buf_len: u16,
    out_buf: *mut u8,
    ...
    let conn = unsafe { &mut *conn };
    let r_out_buf: &mut [u8] =
        unsafe { std::slice::from_raw_parts_mut(out_buf, *out_buf_len as usize) };
...
#[no_mangle]
pub extern "C" fn ossuary_recv_data(
    conn: *mut OssuaryConnection,
    in_buf: *mut u8,
    in_buf_len: *mut u16,
    out_buf: *mut u8,
...
#[no_mangle]
pub extern "C" fn ossuary_remote_public_key(
    conn: *mut OssuaryConnection,
    key_buf: *mut u8,
    key_buf_len: u16,
) -> i32 {
    ...
    let conn = unsafe { &mut *conn };
    let r_key_buf: &mut [u8] = unsafe { std::slice::from_raw_parts_mut(key_buf, KEY_LEN) };
...
#[no_mangle]
pub extern "C" fn ossuary_generate_auth_keypair(
    secret_buf: *mut u8,
    secret_buf_len: u16,
    public_buf: *mut u8,
    public_buf_len: u16,
    ...
    let r_secret: &mut [u8] = unsafe { std::slice::from_raw_parts_mut(secret_buf, KEY_LEN) };
    let r_public: &mut [u8] = unsafe { std::slice::from_raw_parts_mut(public_buf, KEY_LEN) };
